...
{{- define "ack-s3-controller.app.name" -}}
...
*/}}
{{- define "ack-s3-controller.app.fullname" -}}
...
{{- define "ack-s3-controller.chart.name-version" -}}
...
{{- define "ack-s3-controller.aws.credentials.secret_mount_path" -}}
{{- "/var/run/secrets/aws" -}}
{{- end -}}

{{/* The path the shared credentials file is mounted */}}
{{- define "ack-s3-controller.aws.credentials.path" -}}
{{ $secret_mount_path := include "ack-s3-controller.aws.credentials.secret_mount_path" . }}
{{- printf "%s/%s" $secret_mount_path .Values.aws.credentials.secretKey -}}
{{- end -}}

{{/* The rules a of ClusterRole or Role */}}
{{- define "ack-s3-controller.rbac-rules" -}}
rules:
- apiGroups:
  - ""
  resources:
...
{{- define "ack-s3-controller.feature-gates" -}}
{{- $list := list -}}
