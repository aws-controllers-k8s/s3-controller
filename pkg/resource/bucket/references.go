...
func (rm *resourceManager) ClearResolvedReferences(res acktypes.AWSResource) acktypes.AWSResource {
	...
	if ko.Spec.Replication != nil {
		if ko.Spec.Replication.RoleRef != nil {
			ko.Spec.Replication.Role = nil
		}
	}
...
func (rm *resourceManager) ResolveReferences(
	...
	if fieldHasReferences, err := rm.resolveReferenceForReplication_Role(ctx, apiReader, ko); err != nil {
...
func validateReferenceFields(ko *svcapitypes.Bucket) error {
	...
	if ko.Spec.Replication != nil {
		if ko.Spec.Replication.RoleRef != nil && ko.Spec.Replication.Role != nil {
			return ackerr.ResourceReferenceAndIDNotSupportedFor("Replication.Role", "Replication.RoleRef")
		}
	}
	return nil
}

// resolveReferenceForReplication_Role reads the resource referenced
// from Replication.RoleRef field and sets the Replication.Role
// from referenced resource. Returns a boolean indicating whether a reference
// contains references, or an error
func (rm *resourceManager) resolveReferenceForReplication_Role(
	ctx context.Context,
	apiReader client.Reader,
	ko *svcapitypes.Bucket,
) (hasReferences bool, err error) {
	if ko.Spec.Replication != nil {
		if ko.Spec.Replication.RoleRef != nil && ko.Spec.Replication.RoleRef.From != nil {
			hasReferences = true
			arr := ko.Spec.Replication.RoleRef.From
			if arr.Name == nil || *arr.Name == "" {
				return hasReferences, fmt.Errorf("provided resource reference is nil or empty: Replication.RoleRef")
			}
			...
			ko.Spec.Replication.Role = (*string)(obj.Status.ACKResourceMetadata.ARN)
		}
	}
